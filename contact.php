    ...
    <body id="flex_body_accueil">
        <header> 
            ...
            <div class= "titre text_center">
                ~~ Marche Aquatique ~~ </br> Les randonneurs des Sables du Born
            </div>
            <div>
...
<?php require_once("src/navbar.php") ?>
    ...
    <form method="POST" action="traitement_contact.php" id="contact_formulaire" class="form_container text_center">
